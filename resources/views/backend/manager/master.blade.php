...
<head>
	...
	<!--favicon-->
	@include('backend..manager.includes.style')
    @stack('style')
    <style>
        .custom-green-badge{
            margin-left: 20px;
...
<body>
	...
	<div class="wrapper">
		<!--sidebar wrapper -->
		@include('backend..manager.includes.nav')
		<!--end sidebar wrapper -->
		<!--start header -->
		@include('backend..manager.includes.header')
		<!--end header -->
		<!--start page wrapper -->
	...
	<!--end switcher-->
	<!-- Bootstrap JS -->
	@include('backend..manager.includes.script')
    @stack('scripts')
{{--    <script>--}}
{{--        (function() {--}}

...
<head>
    ...
    <title>Monthly Admission Advance Report</title>
...
<div class="addmission-form-wrapper">
    <h2 style="text-align: center;">Monthly Admission Advance Report</h2>
    <hr>
    <table style="border: 1px solid #000000; margin: auto; height: auto; width: 100%" class="table table-bordered">
        ...
        @foreach($admissionStudentsDateFiltering as $admissionStudentFilter)
            ...
            @php
                ...
                if($admissionStudentFilter->admissionForm ? $admissionStudentFilter->admissionForm->course == 'english' : ''){
                    $eng += count(array($admissionStudentFilter->admissionForm->course));
                }

                                ...
                                <div class="input-group mb-3">
                                    <select class="form-control" name="batch_number">
                                        ...
                                        @foreach($data['admissionStudentsBatch'] as $admissionStudentBatch)
                                            <option value="{{ $admissionStudentBatch->batch_no }}">{{ ucfirst($admissionStudentBatch->batch_no) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <table id="" class="table table-striped table-bordered">
                                ...
                                @foreach($admissionStudents as $admissionStudent)
                                    <tr>
                                        ...
                                        <td>{{ $admissionStudent->moneyReceipt->second_due_payment ?? 0 }}Tk.</td>
                                        <td>{{ $admissionStudent->moneyReceipt->third_due_payment ?? 0 }}Tk.</td>
                                        <td>{{ $admissionStudent->moneyReceipt->four_due_payment ?? 0 }}Tk.</td>
                                        <td>{{ $admissionStudent->moneyReceipt->five_due_payment ?? 0 }}Tk.</td>

                    ...
                    <div class="addmission-form-wrapper">
                        <div class="addmission-form-heading">
                            <div class="addmission-list-btn-outer">
                                <a href="{{ url('admin/students/list') }}" class="addmission-list-btn-inner">Back</a>
                            </div>
                        ...
                        <form class="form-group addmission-form" action="{{ url('/admin/admission/update/'.$editAdmissionForm->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">

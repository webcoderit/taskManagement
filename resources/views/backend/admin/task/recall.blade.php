    ...
    <div class="page-wrapper" style="margin-left: 20px!important;">
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <form class="form-group" action="{{ url('/admin/user/recall') }}" method="get">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group" style="margin-top: 25px;">
                                            ...
                                            <a href="{{ url('/admin/user/recall') }}" class="input-group-text btn btn-danger" id="basic-addon2">Clear</a>
                                        </div>
                                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tr>
                                <td style="font-weight: 700">Total Admission : {{ count($recalls) }}</td>
                            </tr>
                        </table>
                    </div>
                    {{ $recalls->links() }}

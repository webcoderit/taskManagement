                        ...
                        <div class="card radius-10" style="background-color: #0bb2d3">
                            <div class="card-body text-center">
                                ...
                                <h3 class="mb-3 text-white">
                                    {{ number_format($todayTotal,2 ?? 0) }} Tk.
                                </h3>
                                <div id="chart1"></div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card radius-10" style="background-color: deepskyblue">
                            <div class="card-body text-center">
                                ...
                                <h3 class="mb-3 text-white">{{ number_format($monthlyTotal,2 ?? 0) }} Tk.</h3>
                                <div id="chart2"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-md-12">
                        <div class="card radius-10" style="background-color: orangered">
                            <div class="card-body text-center">
                                ...
                                <h3 class="mb-3 text-white">{{ number_format(\App\Models\MoneyReceipt::where('is_reject', 0)->get()->sum('today_pay'),2) ?? 0 }} Tk.</h3>
                                <div id="chart5"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-md-12">
                        <div class="card radius-10" style="background-color: #641111">
                            <div class="card-body text-center">
                                ...
                                <h3 class="mb-3 text-white">{{ number_format($totalEarning = $monthlyTotal + $monthlyDueCollect,2) }}</h3>
                                <div id="chart5"></div>
                            </div>
                        </div>
                    </div>

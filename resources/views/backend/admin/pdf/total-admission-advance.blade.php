...
<head>
    ...
    <title>Total Admission Advance Report</title>
...
<div class="addmission-form-wrapper">
    <h2 style="text-align: center;">Total Admission Advance Report</h2>
    <hr>
    <table style="border: 1px solid #000000; margin: auto; height: auto; width: 100%" class="table table-bordered">
        ...
        @php
            ...
            $adm = 0
        @endphp
        @foreach($totalAdmissionAdvance as $admissionStudentFilter)
            <tr>

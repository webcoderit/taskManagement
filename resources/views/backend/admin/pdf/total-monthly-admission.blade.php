...
<head>
    ...
    <title>Total Monthly Admission Report</title>
...
<div class="addmission-form-wrapper">
    <h2 style="text-align: center;">Total Monthly Admission Report</h2>
    <hr>
    <table style="border: 1px solid #000000; margin: auto; height: auto; width: 100%" class="table table-bordered">
        ...
        @endforeach
            <tr>
                <td colspan="4"></td>
                <td>
                    <span style="font-weight: bold">Total Monthly Admission Amount : {{ number_format($sum,2) }}</span>
                </td>
{{--                <td>--}}

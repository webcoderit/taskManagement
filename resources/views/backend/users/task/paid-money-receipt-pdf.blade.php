...
<section class="money-receipt-view mt-2">
    <div class="container">
        <div class="row">
                    ...
                    <div class="money-receipt-info-wrapper">
                        <div class="money-receipt-info-item">
                            <div class="stu-id">
                                ...
                                <span>{{ ucfirst($data['moneyReceipt']->admissionForm->course) ?? '' }} - {{ $data['moneyReceipt']->admissionForm->student_id ?? '' }}</span>
                            </div>
                            <div class="admission-date">
                                <span class="money-receipt-view-label">Admission Date :</span>
                                <span>{{ $data['moneyReceipt']->admission_date->format('Y-m-d') ?? ' ' }}</span>
                            </div>
                        </div>
                        <div class="money-receipt-info-item">
                            <div>
                                <span class="money-receipt-view-label">Student Name :</span>
                                <span>{{ $data['moneyReceipt']->admissionForm->s_name ?? ' ' }}</span>
                            </div>
                            <div>
                                <span class="money-receipt-view-label">Phone :</span>
                                <span>{{ $data['moneyReceipt']->admissionForm->s_phone ?? ' ' }}</span>
                            </div>
                        </div>
                        <div class="money-receipt-info-item">
                            <div>
                                ...
                                <span>
                                    ...
                                    @elseif($data['moneyReceipt']->admissionForm->course == 'attachment_web')
                            ...
                            <div>
                                ...
                                <span>{{ $data['moneyReceipt']->admissionForm->batch_no }}</span>
                            </div>
                        </div>
                        <div class="money-receipt-info-item">
                            <div>
                                <span class="money-receipt-view-label">Total Fee :</span>
                                <span>{{ $data['moneyReceipt']->total_fee }} TK </span>
                            </div>
                            <div>
                        ...
                        <div class="money-receipt-info-item">
                            <div>
                                ...
                                <span>{{ $data['moneyReceipt']->advance }} TK. <small style="color: red">( With Cost )</small> </span>
                            </div>
                            <div>
                                @if($data['moneyReceipt']->today_pay != null)
                                <span class="money-receipt-view-label">Second Payment :</span>
                                <span>{{ $data['moneyReceipt']->today_pay ?? "Not Yet" }} TK. <small style="color: red">( With Cost )</small> </span>
                                @else
            ...
            <!-- <a href="{{ url('/money/receipt/download/'.$data['moneyReceipt']->id) }}" class="money-receipt-download-btn pull-right mt-3">
